...
public class Words {
    ...
    public static final String AUTHORITY = "com.example.latoris.databasepractice";//URI授权者
        ...
        public static final String MINE_ITEM = "vnd.example.latoris.databasepractice";
